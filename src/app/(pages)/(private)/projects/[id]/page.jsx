...
export default function ProjectPage() {
  ...
  const [showProjectNameTextfield,setShowProjectNameTextfield] = useState(false);
  const {loadingUpdateProjectName,errorUpdateProjectName,helperTextUpdateProjectName,startEditing,cancelEditing,handleProjectInputChange,handleUpdateProjectName,handleProjectInputKeyDown,projectName} = useUpdateProjectName(activeProject?.name,setShowProjectNameTextfield);
  const {loadingDeleteProject,errorDeleteProject,deleteProject} = useDeleteProject();
        ...
        {!loadingGetProject ? (
          ...
          <Box>
          {
            showProjectNameTextfield ? (
               ...
               onKeyDown={(e)=>handleProjectInputKeyDown(e,activeProject?.id)}
               minWidth="300px"
          ...
          <Box display={'flex'} gap={'2px'} alignItems={'center'}>
            ...
            sx={{
             ...
             <img src="/rename.svg" style={{width:"100%",height:"100%",objectFit:'cover',textIndent:"10000px"}} />
            </Box>
            <Box 
            ...
            sx={{
             ...
             <img src="/delete.svg" style={{width:"100%",height:"100%",objectFit:'cover',textIndent:"10000px"}} />
            </Box>
          </Box>
        </Box>
        ) : null}
